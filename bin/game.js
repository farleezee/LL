...
const doorframeFuturistic2 = new Entity('doorframeFuturistic2')
engine.addEntity(doorframeFuturistic2)
doorframeFuturistic2.setParent(_scene)
const transform9 = new Transform({
  position: new Vector3(0.8469578623771667, 0, 0),
  rotation: new Quaternion(-1.5394153601527394e-15, 0.7071068286895752, -8.429369557916289e-8, 0.7071068286895752),
  scale: new Vector3(1.0000011920928955, 1.5, 1.0000011920928955)
})
doorframeFuturistic2.addComponentOrReplace(transform9)
const gltfShape8 = new GLTFShape("e6894404-f9c6-49f9-83a1-b30f5f30a054/FuturisticDoorframe.glb")
gltfShape8.withCollisions = true
gltfShape8.isPointerBlocker = true
gltfShape8.visible = true
doorframeFuturistic2.addComponentOrReplace(gltfShape8)

const doorframeFuturistic = new Entity('doorframeFuturistic')
engine.addEntity(doorframeFuturistic)
doorframeFuturistic.setParent(_scene)
const transform10 = new Transform({
  position: new Vector3(15.17979621887207, 0, 2.1069765090942383),
...
doorframeFuturistic.addComponentOrReplace(transform10)
doorframeFuturistic.addComponentOrReplace(gltfShape8)
...
wallZigzag.addComponentOrReplace(transform11)
...
wallPinkBoards.addComponentOrReplace(transform12)
const gltfShape9 = new GLTFShape("f6fb3031-dc9e-4a10-92a5-ffaac7339e50/PinkBoardsWall.glb")
gltfShape9.withCollisions = true
gltfShape9.isPointerBlocker = true
gltfShape9.visible = true
wallPinkBoards.addComponentOrReplace(gltfShape9)
...
nft.addComponentOrReplace(transform13)
...
nft2.addComponentOrReplace(transform14)
